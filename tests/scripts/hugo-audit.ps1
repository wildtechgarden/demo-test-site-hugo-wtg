...
hugo.exe  --gc --buildDrafts --buildFuture --environment "development" --destination "$curdir\public" --source "$curdir\tests\config" --config "$curdir\tests-config\demo-site.toml,$curdir\hugo.toml"
